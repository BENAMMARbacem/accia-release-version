        ...
        <div className="h-full w-full bg-gray-100 flex items-center">
          <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div className="max-w-md">
              ...
              <p className="mb-8">
                Mais ne vous inquiétez pas, vous pouvez trouver beaucoup d’autres choses sur notre page d’accueil        </p>
              <Link to={"/links"} className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700 text-white-A700">
                Retour à l'accueil
